...
void cpuSHA256(const char *input, uint32_t *hashOut)
{
    ...
    for (int i = 0; i < 8; i++)
    {
        padded[56 + i] = (bitLen >> (56 - 8 * i)) & 0xFF;
    }
    ...
    hashOut[0] = a + 0x6a09e667;
    hashOut[1] = b + 0xbb67ae85;
    hashOut[2] = c + 0x3c6ef372;
    hashOut[3] = d + 0xa54ff53a;
    hashOut[4] = e + 0x510e527f;
    hashOut[5] = f + 0x9b05688c;
    hashOut[6] = g + 0x1f83d9ab;
